...
<div id="stag-admin-wrap" class="advanced-wrap">
    <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" id="stag-form-advanced">
      <div class="stag-header">
        <h1>Foley Timber &amp; Land Co. - Debug Info</h1>
        <p>Please do not edit without consulting SMG</p>
        
        <div id="stag-logo"></div>
      </div>
      ...
      <div class="stag-content cf stag-tab-advanced">
        ...
        <div class="page">
            ...
            <div class="row clearfix">
              ...
              <div class="desc">
                <p>Download site debug information.</p>
              ...
              <div class="input theme-debug-info">
                <p><span>Build:</span> <?php echo STAG_FRAMEWORK_VERSION; ?></p>
