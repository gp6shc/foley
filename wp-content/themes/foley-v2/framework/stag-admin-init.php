...
function stag_menu(){
  ...
  add_object_page( STAG_THEME_NAME, 'Advanced', 'update_core', 'stagframework', 'stag_options_page', $icon );
  add_submenu_page('stagframework', __('Theme Settings', 'stag'), __('Settings', 'stag'), 'update_core', 'stagframework', 'stag_options_page' );
  add_submenu_page('stagframework', __('Debugging', 'stag'), __('Debugging', 'stag'), 'update_core', 'stagframework-advanced', 'stag_advanced' );
...
add_action('wp_head', 'stag_link_custom_styles', 10);
