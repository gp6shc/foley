...
<div id="primary" class="hfeed" role="main">
    ...
    <div class="portfolio-meta">
        ...
        <?php if(!empty($projectDate)){ ?>
            <span><strong>Project Date: </strong><?php echo stag_date('F', $projectDate) .' '. stag_date('d', $projectDate) . ', '. stag_date('Y', $projectDate); ?></span>
        <?php } ?>
        ...
        ?>
            <span><strong>Skills: </strong><?php echo implode($skill, ', '); ?></span>
        <?php } ?>
    ...
    <div class="entry-content">
        <?php
            ...
            if(!empty($projectUrl)){
                ...
                <a href="<?php echo $projectUrl; ?>" class="button project-button"><?php _e('Go to Project', 'stag') ?></a>
